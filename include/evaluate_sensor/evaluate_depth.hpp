...
public:
  ...
  void test_corners(cv_bridge::CvImagePtr cv_ptr, const int &w, const int &h, const int &max);

  void test_hist(cv_bridge::CvImagePtr cv_ptr, const int &w, const int &h, const int &bins);
